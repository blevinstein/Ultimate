...
export class Cutter {
  ...
  // cutter to run to.
  static chooseBestRandomDestination(game, team, numCandidateRoutes = 10) {
    ...
    for (let i = 0; i < numCandidateRoutes; i++) {
      ...
      let closestDefenderDistance = Game.getClosestPlayer(game.defensiveTeam().players, newDestination)[1];
