...
const {
  ClosestPickupStrategy
} = require('./strategy/closest_pickup.js');
const {
  IdleStrategy
} = require('./strategy/idle.js');
const {
  KickoffStrategy
} = require('./strategy/kickoff.js');
const {
  LineupStrategy
} = require('./strategy/lineup.js');
const {
  ManToManDefenseStrategy
} = require('./strategy/man_defense.js');
const {
  ManualOffenseStrategy
} = require('./strategy/manual_offense.js');
const {
  RandomOffenseStrategy
