...
function sub3d(a, b) { return [ a[0] - b[0], a[1] - b[1], a[2] - b[2] ]; }
...
function dot3d(a, b) { return a[0] * b[0] + a[1] * b[1] + a[2] * b[2]; }
...
function angle2d(vector) { return Math.atan2(vector[1], vector[0]); }
